...
//Este Objeto é responsavel pela disciplina e nota do Aluno
public class Disciplina {
	...
	public String toString() {
		return "\nDisciplina 1: " + disciplina1 + "Nota1 - " + nota1 + "\nDisciplina 2: " + disciplina2
				+ "Nota2 - " + nota2 + "\nDisciplina 3: " + disciplina3 + "Nota3 - " + nota3 + "\nDisciplina 4: "
